...
<?php
    ...
    if (isset($_POST['register'])){        
     ...
     mysql_query("INSERT INTO `inventory`(`asset_code`, `date_purchased`, `estimated_value`, `location`, `mode_make`, `purchase_price`, `serial_number`, `asset_condition`, `quantity`, `order_number`, `active`,`reason_for_disposing`, `updated_by`) VALUES ('$asset_code','$date_purchased','$estimated_value','$location','$mode_make','$purchase_price','$serial_number','$asset_condition','$quantity','$order_number','$active','$reason_for_disposing','$updated_by')") or die(mysql_error());

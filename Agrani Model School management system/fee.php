...
<?php
    ...
    $xx=$_POST['course_id'];
        ...
        $course_id = $row['course_id'];
         ...
         mysql_query("INSERT INTO fee (method, refno, admission_number, tdate, course_id, term_id, amount,captured_by)
          VALUES ('$method','$refno','$admission_number','$tdate','$course_id','$term_id','$amount','$captured_by')") or die(mysql_error());    

...
mysql_query("INSERT INTO
 packages_marks(
    `admission_number`, `course_id`, `term`, `year`, `INTRODUCTION_TO_COMPUTERS`, `MS_WINDOWS`, `MS_EXCEL`, `MS_ACCESS`, `MS_PUBLISHER`, `MS_POWERPOINT`, `MS_WORD`, `INTERNET_AND_EMAIL`, `average` )
     VALUES
      ('$admission_number','$course_id','$term','$year','$introduction_to_computers','$ms_windows','$ms_excel','$ms_access','$ms_publisher','$ms_powerpoint','$ms_word','$internet_and_email','$average')") or die(mysql_error());
?>
<?php 

...
<div class="col-sm-6" >
	...
	$query = mysql_query("select * from admin where username = '$username' and password = '$password' and fname = '$fname' and lname = '$lname' and email = '$email' and role = '$role' ")or die(mysql_error());
...
<?php
	...
	mysql_query("insert into admin (fname,lname,username,password,email,role) values('$fname','$lname','$username','$password','$email','$role')")or die(mysql_error());

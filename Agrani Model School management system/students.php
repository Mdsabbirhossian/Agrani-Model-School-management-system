...
<?php
    ...
    //<!--**************************************************************>
     ...
     mysql_query("INSERT INTO studentstable(admission_number, sirname, firstname, lastname, idno, dateofbirth, gender, country_id, county_id, constituency_id, mobile, email, address, zipcode, course_id, border,reg_date, feepayable, emergency_contact)
      VALUES ('$admission_number','$sirname','$firstname','$lastname','$idno','$dateofbirth','$gender','$country_id','$county_id','$constituency_id','$mobile','$email','$address','$zipcode','$course_id','$border','$reg_date','$finalfee','$emergency_contact')") or die(mysql_error());

  ...
  <?php
    ...
    if (isset($_POST['register'])){
        ...
        $captured_by=$_POST['captured_by'];
         ...
         mysql_query("INSERT INTO expence(expence_date, description, expence_amount,captured_by) VALUES ('$expence_date','$description','$expence_amount','$captured_by')") or die(mysql_error());
